...
type Trade struct {
	...
	ExpertImages               *string    `json:"expert_images,omitempty"` // 達人觀察圖
	EliteImages                *string    `json:"elite_images,omitempty"`  // 菁英觀察圖
...
type TradeQuery struct {
	...
	ColorTag  string `form:"color_tag"` // "red", "yellow", "green"
}
