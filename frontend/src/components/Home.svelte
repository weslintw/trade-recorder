              ...
              {#if group.plans.length > 0}
                {#each group.plans as plan}
                  ...
                  >
                    ...
                    {#if isUnified}
                      <div class="plan-summary-table-wrapper">
                                  ...
                                  <td class="trend-cell {trend?.direction || 'na'}">
                                    {#if trend?.direction}
                                      <div class="cell-direction">
                                        {trend.direction === 'long' ? '多' : trend.direction === 'short' ? '空' : trend.direction === 'both' ? '整' : ''}
                                      </div>
...
<style>
  ...
  .side-box::before {
    content: attr(class);
    display: none; /* Just for reference */
  }
