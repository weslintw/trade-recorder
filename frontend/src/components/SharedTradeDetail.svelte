...
<style>
  ...
  .rr-value { font-weight: 700; }
  .rr-value.profit { color: #10b981; }
  .rr-value.loss { color: #ef4444; }
  ...
  .section-box { margin: 2.5rem 0; }
  .section-box h3 { font-size: 1.25rem; font-weight: 800; color: #1e293b; margin-bottom: 1.25rem; display: flex; align-items: center; gap: 0.6rem; }
  ...
  .image-card { border-radius: 12px; overflow: hidden; border: 1px solid #e2e8f0; }
  .clickable-image { width: 100%; height: 150px; object-fit: cover; cursor: pointer; transition: transform 0.2s; }
  ...
  .analysis-tag { 
    background: #ebf4ff; color: #2b6cb0; padding: 4px 12px; border-radius: 6px; font-size: 0.85rem; font-weight: 700; display: inline-flex; align-items: center; gap: 0.5rem;
  }
  ...
  @media (max-width: 768px) {
    .info-row-group { grid-template-columns: 1fr 1fr; }
    .analysis-sub-flex.horizontal-layout { gap: 1.5rem; }
